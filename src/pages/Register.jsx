            ...
            <form onSubmit={handleSubmit}>
              <div className="row g-3">
                {[{f:"name",l:"Full Name",t:"text",ph:"John Doe"},{f:"email",l:"Email",t:"email",ph:"john@email.com"},{f:"phone",l:"Phone",t:"tel",ph:"+91 98765 43210"}].map(x=>(
                  <div key={x.f} className="col-12"><label style={{color:"#1a1a1a",fontFamily:"'DM Sans',sans-serif",fontSize:13,fontWeight:700,marginBottom:6,display:"block"}}>{x.l} *</label><input type={x.t} style={inp} placeholder={x.ph} value={form[x.f]} onChange={e=>setForm({...form,[x.f]:e.target.value})} required/></div>
                ))}
                ...
                <div className="col-6"><label style={{color:"#1a1a1a",fontFamily:"'DM Sans',sans-serif",fontSize:13,fontWeight:700,marginBottom:6,display:"block"}}>Password *</label><input type="password" style={inp} placeholder="Min 6 chars" value={form.password} onChange={e=>setForm({...form,password:e.target.value})} required minLength={6}/></div>
