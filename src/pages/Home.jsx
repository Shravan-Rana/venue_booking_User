        ...
        <div className="auto-container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 text-lg-end mt-4 mt-lg-0">
              <Link to="/register" className="btn-1" style={{ background: "#fff", color: "var(--theme-color)", border: "none" }}>Create Free Account <span style={{ background: "#2B2D42", color: "#fff" }}></span></Link>
            </div>
          </div>
        </div>
      </section>
